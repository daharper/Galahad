...
//        function Map<U>(const aMapper: TFunc<T, U>): TListOps<U>; overload;
...
begin
  Ensure.IsAssigned(fList, 'Predicate is nil').IsAssigned(@aComparison, 'Comparison is nil');
...
begin
  Ensure.IsAssigned(fList, 'Predicate is nil').IsAssigned(aComparer, 'Comperer is nil');
...
begin
  Ensure.IsAssigned(aList, 'Predicate is nil');
