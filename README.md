...
**Project.groupproj** opens both projects; for individual projects open **Galahad.dproj** or **Escape.dproj**. Once Escape is finished, I'll separate the two repositories - but for now, with Escape currently driving ongoing refactoring of the initial version of Galahad, I'll keep them together temporarily.
